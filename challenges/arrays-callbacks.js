...
*/
console.log("------- zooAnimals map -------");

const lowCaseAnimalNames = zooAnimals.map((items)=>{return items.animal_name.toLowerCase()});
...
let populationTotal = zooAnimals.reduce((acc,obj)=>{return acc + obj.population},0);
...
console.log("[x] ------ Stretch: Arrays & Callbacks ------ ")
/*
