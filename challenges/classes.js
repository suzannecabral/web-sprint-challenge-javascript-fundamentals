...
*/
console.log("------- Cuboid Constructor: Class --------");

//PROTOTYPE
// function CuboidMaker(attrs){
//   this.cuboidLength = attrs.cuboidLength,
//   this.cuboidWidth = attrs.cuboidWidth,
//   this.cuboidHeight = attrs.cuboidHeight
// }
...
class CubeMakerClass extends CuboidMakerClass {
    ...
    volume(){
        ...
        return Math.pow(this.cWidth,3) 
    }
    surfaceArea(){
        console.log("Cube Surface");
        return 6 * (Math.pow(this.cWidth,2));
    }
}
